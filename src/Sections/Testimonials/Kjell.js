...
const Kjell = () => {
  ...
  return (
    <div className="relative flex-col lg:mt-4 mt-12">
      <img
        src={`${process.env.PUBLIC_URL}/assets/general_back.svg`}
        className="absolute bottom-0 left-0"
      ></img>
      <div className="flex xl:flex-row-reverse flex-col w-full relative items-center gap-8  lg:items-end">
        {isMobile ? (
          ...
          <motion.div
            className="flex flex-col gap-0 items-start justify-start w-[100%] order-1"
        ...
        <div className="container flex flex-wrap xl:content-start content-center min-w-0">
          {isMobile ? (
            <div className="flex flex-col gap-0 order-3">
            ...
            <motion.div
              className="flex flex-col gap-0 xl:order-1 order-3"
          ...
          <div className="testimonials2 relative vsm:w-[100%]">
            <div className="flex lg:flex-row vsm:flex-col vsm:gap-0 gap-10 items-center justify-end pl-4 width-[100%] h-full">
              <div className=" relative z-[1]">
                ...
                <p className="font-bold text-[22px] text-white whitespace-nowrap hidden vsm:block">
                  Kjell GRANDHAGEN
                </p>
              </div>
              <div className="relative vsm:hidden z-[1] w-[3px] h-[70%] origin-top-left bg-white"></div>
