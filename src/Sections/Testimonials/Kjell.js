...
const Kjell = () => {
  ...
  return (
    <div className="relative flex-col lg:mt-4 mt-12" suppressHydrationWarning={true}>
      ...
      {isMobile ?
        <div className="flex flex-col gap-0 items-end justify-center lg:w-auto w-[100%] order-1"
        >
          {
            <img
        ...
        :
        <motion.div className="flex flex-col gap-0 items-start justify-start xl:w-auto w-[100%] order-1"
        ...
        <div className="container flex flex-wrap xl:content-start content-center min-w-0 xl:pl-0">
          ...
          >
            ...
            <p className="quote text-white font-sans 2xl:text-[50px] xl:text-[45px] lg:text-[40px] xl:whitespace-normal text-[35px] lg:text-left text-center">
          ...
          viewport={{ once: true }}>
            ...
            <p className="quote text-white font-sans 2xl:text-[35px] xl:text-[30px] lg:text-[36px] text-[30px] lg:text-left text-center">
            The centralized model where the hacking of a single device that could compromise an entire network is categorically flawed. This needs to change. We don’t need to play a better game against cyber-criminals, we need to play a different game. With Naoris Protocol, there is no single point of failure. Naoris Protocol uses Blockchain technology so that no single device exists in a silo.
            </p>
            <span className="text-[#00FFA3] 2xl:text-[200px] xl:text-[170px] lg:text-[150px] font-normal transform rotate-180 leading-[0] text-[120px]">
              “
